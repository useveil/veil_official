...
title:
  ...
  ja: v0.1.0 RC · 初の公開リリース候補
  ko: v0.1.0 RC · 첫 공개 릴리스 후보
summary:
  ...
  ja: Veil の単一デバイス完全版 RC です。デスクトップアプリ、Profile、プロキシ、フィンガープリントエンジン、監査ログ、自動化 API がすべてそろいました。
  ko: Veil 단일 디바이스 완성형 RC 입니다. 데스크톱 앱, Profile, 프록시, 핑거프린트 엔진, 감사 로그, 자동화 API 가 모두 준비되었습니다.
---
