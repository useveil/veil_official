      ...
      <div className="mx-auto max-w-7xl px-6 py-24 md:py-32">
        <div className="grid gap-12 lg:grid-cols-[1fr_1.4fr] lg:items-start lg:gap-16">
          ...
          <Reveal className="min-w-0">
            ...
            <div className="mt-8 min-w-0 rounded-lg border border-border bg-background p-4 shadow-sm">
              <div className="flex items-center gap-2 font-mono text-[11px] uppercase text-foreground-subtle">
                <Lock className="h-3.5 w-3.5" />
                {t('shellLabel')}
              </div>
              <pre className="mt-2 min-w-0 overflow-x-auto font-mono text-xs text-foreground">
            ...
            <ul className="grid gap-3">
              {authFeatures.map((feature) => {
                ...
                return (
                  <li
                    key={feature.key}
                    className="flex items-start gap-4 rounded-lg border border-border bg-background p-5 shadow-sm"
                  >
